  ...
  return {
    ...
    animateAll: function(n) {
      ...
      i.forEach(function(l) {
        ...
        (v.top - d.top) / (v.left - d.left) === (h.top - d.top) / (h.left - d.left) && (s = Ze(v, g, y, o.options)), qt(d, h) || (u.prevFromRect = h, u.prevToRect = d, s || (s = o.options.animation), o.animate(u, v, d, s)), s && (r = !0, a = Math.max(a, s), clearTimeout(u.animationResetTimer), u.animationResetTimer = setTimeout(function() {
    ...
    animate: function(n, o, r, a) {
      if (a) {
        ...
        n.animatingX = !!h, n.animatingY = !!d, p(n, "transform", "translate3d(" + h + "px," + d + "px,0)"), this.forRepaintDummy = Ue(n), p(n, "transition", "transform " + a + "ms" + (this.options.easing ? " " + this.options.easing : "")), p(n, "transform", "translate3d(0,0,0)"), typeof n.animated == "number" && clearTimeout(n.animated), n.animated = setTimeout(function() {
...
var c, C, m, _, lt, Bt, S, tt, dt, k, St, Q, At, O, ct = !1, Gt = !1, zt = [], rt, Y, Zt, Jt, ve, be, Et, ut, Ct, Tt = !1, Nt = !1, kt, x, Kt = [], ie = !1, jt = [], $t = typeof document < "u", Pt = ye, Ee = It || Z ? "cssFloat" : "float", Qe = $t && !De && !ye && "draggable" in document.createElement("div"), xe = function() {
  if ($t) {
    if (Z)
      return !1;
...
f.prototype = /** @lends Sortable.prototype */
{
  ...
  _emulateDragOver: function() {
    if (Y) {
      this._lastX = Y.clientX, this._lastY = Y.clientY, Pe();
  ...
  _onDragStart: function(t, e) {
    ...
    P("setupClone", this), f.eventCanceled || (S = Ie(c), S.removeAttribute("id"), S.draggable = !1, S.style["will-change"] = "", this._hideClone(), B(S, this.options.chosenClass, !1), f.clone = S), n.cloneId = Ft(function() {
  ...
  _onDragOver: function(t) {
    ...
    if (Gt = !1, u && !l.disabled && (h ? d || (a = C !== _) : O === this || (this.lastPutMode = At.checkPull(this, u, c, t)) && s.checkPut(this, u, c, t))) {
      ...
      if (!L || ln(t, y, this) && !L.animated) {
        ...
        r = I(n);
        var z = 0, it, pt = c.parentNode !== e, M = !tn(c.animated && c.toRect || o, n.animated && n.toRect || r, y), mt = y ? "top" : "left", J = me(n, "top", "top") || me(c, "top", "top"), gt = J ? J.scrollTop : void 0;
        ut !== n && (it = r[mt], Tt = !1, Nt = !M && l.invertSwap || pt), z = sn(t, n, r, y, M ? 1 : l.swapThreshold, l.invertedSwapThreshold == null ? l.swapThreshold : l.invertedSwapThreshold, Nt, ut === n);
        var $;
        if (z !== 0) {
          var ot = R(c);
          do
        ...
        if (xt !== !1)
          return (xt === 1 || xt === -1) && (K = xt === 1), ie = !0, setTimeout(rn, 30), V(), K && !vt ? e.appendChild(c) : n.parentNode.insertBefore(c, K ? vt : n), J && Te(J, 0, gt - J.scrollTop), C = c.parentNode, it !== void 0 && !Nt && (kt = Math.abs(it - I(n)[mt])), X(), A(!0);
      }
      if (e.contains(c))
        return A(!1);
    }
...
function an(i, t, e) {
  var n = I(ft(e.el, 0, e.options, !0)), o = Oe(e.el, e.options, m), r = 10;
  return t ? i.clientX < o.left - r || i.clientY < n.top && i.clientX < n.right : i.clientY < o.top - r || i.clientY < n.bottom && i.clientX < n.left;
}
function ln(i, t, e) {
  var n = I(se(e.el, e.options.draggable)), o = Oe(e.el, e.options, m), r = 10;
...
class Vt {
  constructor(t) {
    ...
    D(this, "buttonGroup");
    this.collection = new Be(), this.buttonGroup = new wn(this), this.element.classList.add("list-group-item"), this.dataset = yn(t);
  }
  setOptions(t) {
    this.options = t;
  }
...
class Tn {
  constructor(t, e = vn) {
    ...
    D(this, "options");
    this.menuContainer = new _n(t), this.sortableClassname = `${t}-nested-sortable`, this.options = e, this.menuContainer.setOptions({ sortableClassname: this.sortableClassname }), this.listenerDeleteButton = () => {
  ...
  htmlToJson(t) {
    ...
    for (var o = 0; o < e.length; o++) {
      let r = e.item(o), a = Dn(r.dataset), l = r.lastElementChild;
